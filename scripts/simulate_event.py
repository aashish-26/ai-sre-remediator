...
mcp_mod = load_module_from(repo_root / "operator" / "pkg" / "mcp_client.py", "mcp_client")
validator_mod = load_module_from(repo_root / "operator" / "pkg" / "validator.py", "validator")
executor_mod = load_module_from(repo_root / "operator" / "pkg" / "executor.py", "executor")
...
valid, reason = validator_mod.validate(mcp_resp, context=context, templates=templates)
if not valid:
